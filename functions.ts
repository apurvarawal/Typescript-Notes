...
function findsum(num1: number, num2: number, num3? : number) : number{
...
const findingsum = (num1: number, num2: number, num3=10) : number => num1+num2+num3;
...
function findsum2(num1:number, num2:number, ...num3:number[]) : number{
